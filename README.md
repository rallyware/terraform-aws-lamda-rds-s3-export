...
|------|-------------|------|---------|:--------:|
| <a name="input_export_task_role_arn"></a> [export\_task\_role\_arn](#input\_export\_task\_role\_arn) | The name of the IAM role to use for writing to the Amazon S3 bucket when exporting a snapshot | `string` | n/a | yes |
| <a name="input_kms_key_id"></a> [kms\_key\_id](#input\_kms\_key\_id) | The ID of the Amazon Web Services KMS key to use to encrypt the data exported to Amazon S3 | `string` | n/a | yes |
...
| <a name="input_s3_bucket_id"></a> [s3\_bucket\_id](#input\_s3\_bucket\_id) | The name of the Amazon S3 bucket to export the snapshot to | `string` | n/a | yes |
