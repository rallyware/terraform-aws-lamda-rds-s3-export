...
| <a name="input_export_key_deletion"></a> [export\_key\_deletion](#input\_export\_key\_deletion) | Duration in days after which the key is deleted after destruction of the resource | `number` | `14` | no |
| <a name="input_export_key_description"></a> [export\_key\_description](#input\_export\_key\_description) | The description of the key as viewed in AWS console | `string` | `"KMS key used by export task"` | no |
| <a name="input_export_role_description"></a> [export\_role\_description](#input\_export\_role\_description) | The description of the IAM role that is visible in the IAM role manager | `string` | `"IAM role used by export task"` | no |
| <a name="input_export_role_policy_description"></a> [export\_role\_policy\_description](#input\_export\_role\_policy\_description) | The description of the IAM policy that is visible in the IAM policy manager | `string` | `"IAM policy for role that used by export task"` | no |
...
| <a name="output_export_key_arn"></a> [export\_key\_arn](#output\_export\_key\_arn) | The ARN of KMS key used by export task |
| <a name="output_export_role_arn"></a> [export\_role\_arn](#output\_export\_role\_arn) | The ARN of IAM role used by export task |
