...
| <a name="input_allowed_kms_alias"></a> [allowed\_kms\_alias](#input\_allowed\_kms\_alias) | A list of KMS aliases that are allowed to be used by the lambda function | `list(string)` | <pre>[<br>  "alias/*rds*"<br>]</pre> | no |
